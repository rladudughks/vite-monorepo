...
import { FieldSectionContentType } from '@mui/x-date-pickers';
import { koKR as pickersKoKR } from '@mui/x-date-pickers/locales';
import * as _ from 'lodash-es';

const customMaterialKoKR = materialKoKR;
const customPickersKoKR = _.merge(pickersKoKR, {
  components: {
      ...
      defaultProps: {
        localeText: {
          fieldYearPlaceholder: (params: {
            digitAmount: number;
            format: string;
          }) => `년도(${params.digitAmount}자리)`,
          fieldMonthPlaceholder: (params: {
            contentType: FieldSectionContentType;
            format: string;
          }) => (params.contentType === 'letter' ? '월' : '월'),
...
const customDatagridKoKR = _.merge(datagridKoKR, {
  components: {
    MuiDataGrid: {
      defaultProps: {
        localeText: {
          ...
          pinAllToLeft: '틀 고정',
          pinAllToRight: '틀 고정',
          unpinAllToLeft: '틀 고정 해제',
          unpinAllToRight: '틀 고정 해제',

          // Root
          noRowsLabel: '표시할 항목이 없습니다.',
          ...
          columnsManagementNoColumns: '열 없음',
          columnsManagementShowHideAllText: '전체 보기/숨기기',
          columnsManagementReset: '초기화',

          // Filter panel text
          // filterPanelAddFilter: '필터 추가',
          filterPanelRemoveAll: '모두 제거',
          ...
          columnMenuManageColumns: '열표시 설정',
          // columnMenuFilter: '필터',
...
const localization = {
  materialKoKR: customMaterialKoKR,
  pickersKoKR: customPickersKoKR,
  datagridKoKR: customDatagridKoKR,
};
